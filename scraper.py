"""
scraper.py — IBM HTTP Server High-Risk CVE Scraper 主程式
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="自動擷取 IBM HTTP Server Security Bulletin 高風險 CVE 並生成 HTML 報表",
...
def main():
    ...
    logger.info("=" * 60)
    logger.info("IBM HTTP Server CVE Scraper 開始執行")
    ...
    try:
        ...
        logger.info("   總計: %d 筆 IBM HTTP Server 高風險 CVE 公告", len(filtered))
        logger.info("=" * 60)
